...
function añadirAlCarrito(productId) {
    // Buscar el producto en la categoría de Electrohogar
    const producto = productosElectrohogar.find(prod => prod.id === productId);
...
function actualizarCarrito() {
    ...
    carrito.forEach(producto => {
        ...
        fila.innerHTML = `
            <td><img src="../img/${producto.imagen}" class="img-thumbnail" width="50" height="50"></td>
